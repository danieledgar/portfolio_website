            ...
            >
              ...
              <div className="w-16 h-16 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                {index === 0 ? (
                  ...
                  // Verdelle Nails - Manicure/hand icon
                  <svg viewBox="0 0 512 512" fill="currentColor" className="w-8 h-8 text-gray-700 dark:text-gray-300">
                    <path d="M170.9,148.1c17.8,0,32.3-14.5,32.3-32.3V32.3C203.2,14.5,188.7,0,170.9,0s-32.3,14.5-32.3,32.3v83.5 C138.6,133.6,153.1,148.1,170.9,148.1z"/>
                    <path d="M244,148.1c17.8,0,32.3-14.5,32.3-32.3V32.3C276.3,14.5,261.8,0,244,0s-32.3,14.5-32.3,32.3v83.5 C211.7,133.6,226.2,148.1,244,148.1z"/>
                    <path d="M317.1,148.1c17.8,0,32.3-14.5,32.3-32.3V32.3C349.4,14.5,334.9,0,317.1,0s-32.3,14.5-32.3,32.3v83.5 C284.8,133.6,299.3,148.1,317.1,148.1z"/>
                    <path d="M390.2,148.1c17.8,0,32.3-14.5,32.3-32.3V32.3C422.5,14.5,408,0,390.2,0c-17.8,0-32.3,14.5-32.3,32.3v83.5 C357.9,133.6,372.4,148.1,390.2,148.1z"/>
                    <path d="M463.3,73.1c-17.8,0-32.3,14.5-32.3,32.3v10.5c0,17.8-14.5,32.3-32.3,32.3h-325c-17.8,0-32.3-14.5-32.3-32.3v-10.5 c0-17.8-14.5-32.3-32.3-32.3S-23,87.5-23,105.4v10.5c0,53.5,43.5,97,97,97h57.6l24.6,167.9c3.9,26.4,26.7,45.9,53.4,45.9h151.5 c26.7,0,49.5-19.5,53.4-45.9l24.6-167.9h57.6c53.5,0,97-43.5,97-97v-10.5C495.6,87.5,481.1,73.1,463.3,73.1z"/>
                  </svg>
                )}
              </div>
